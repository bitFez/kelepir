...
class Maddeler(models.Model):
    ...
    fiyat = models.DecimalField(max_digits=8, decimal_places=2,help_text='İndirimi fıyat', verbose_name='Fıyat')
    ...
    duyurmaTarihi = models.DateTimeField(timezone.now()) # auto_now=False, auto_now_add=True, blank=True
